...
export const metadata: Metadata = {
  ...
  title: {
    default: 'PET AI — Understand Your Pet',
    template: '%s · PET AI',
  },
  ...
  openGraph: {
    ...
    description: 'Turn pet sounds and context into thoughtful, probabilistic interpretations personalized to your pet.',
    url: siteUrl,
  },
  twitter: {
    card: 'summary_large_image',
    title: 'PET AI — Understand Your Pet',
    description: 'AI-assisted, probabilistic pet communication insights.',
  },
  category: 'technology',
}
